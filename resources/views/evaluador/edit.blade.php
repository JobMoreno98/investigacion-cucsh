    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-10">
                ...
                <h3 class="text-center">Folio: {{ $evaluacion->proyecto->folio }} <br>
                    Titulo:{{ $evaluacion->proyecto->titulo_proyecto }}</h3>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <form action="{{ route('evaluaciones.update', $evaluacion->id) }}" class="row" method="POST">
                @method('PUT')
                @csrf
                <input type="text" name="id_proyecto" value="{{ $evaluacion->proyecto->id }}" class="d-none">
                <!-- Pregunta #1 -->
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <select class="form-control" name="p_01[]" id="">
                            ...
                            <option {{ strcmp($evaluacion->p_01[0], 'Cumple') == 0 ? 'selected' : '' }} value="Cumple">
                                Cumple
                            </option>
                            <option {{ strcmp($evaluacion->p_01[0], 'No cumple') == 0 ? 'selected' : '' }}
                                value="No cumple">No
                                cumple
                            </option>
                        </select>
                    ...
                    <div class="col-sm-12 col-md-8">
                        ...
                        <textarea class="form-control" name="p_01[]" id="">{{ $evaluacion->p_01[1] ? $evaluacion->p_01[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <select class="form-control" name="p_02[]" id="">
                            <option disabled selected>Elige una opción</option>
                            <option {{ strcmp($evaluacion->p_02[0], 'Cumple') == 0 ? 'selected' : '' }} value="Cumple">
                                Cumple
                            </option>
                            <option {{ strcmp($evaluacion->p_02[0], 'No cumple') == 0 ? 'selected' : '' }}
                                value="No cumple">No
                                cumple</option>
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_02[]" id="p_02">{{ $evaluacion->p_02[1] ? $evaluacion->p_02[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input class="form-control monto" min="0" max="10" type="number" onchange="suma()"
                            value="{{ $evaluacion->p_03[0] ? $evaluacion->p_03[0] : '0' }}" name="p_03[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_03[]" id="">{{ $evaluacion->p_03[1] ? $evaluacion->p_03[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number" onchange="suma()"
                            value="{{ $evaluacion->p_04[0] ? $evaluacion->p_04[0] : '0' }}" name="p_04[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_04[]" id="">{{ $evaluacion->p_04[1] ? $evaluacion->p_04[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number" onchange="suma()"
                            value="{{ $evaluacion->p_05[0] ? $evaluacion->p_05[0] : '0' }}" name="p_05[]"
                            id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_05[]" id="">{{ $evaluacion->p_05[1] ? $evaluacion->p_05[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_06[0] ? $evaluacion->p_06[0] : '0' }}"
                            name="p_06[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_06[]" id="">{{ $evaluacion->p_06[1] ? $evaluacion->p_06[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_07[0] ? $evaluacion->p_07[0] : '0' }}"
                            name="p_07[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_07[]" id="">{{ $evaluacion->p_07[1] ? $evaluacion->p_07[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_08[0] ? $evaluacion->p_08[0] : '0' }}"
                            name="p_08[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_08[]" id="">{{ $evaluacion->p_08[1] ? $evaluacion->p_08[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_09[0] ? $evaluacion->p_09[0] : '0' }}"
                            name="p_09[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_09[]" id="">{{ $evaluacion->p_09[1] ? $evaluacion->p_09[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_10[0] ? $evaluacion->p_10[0] : '0' }}"
                            name="p_10[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_10[]" id="">{{ $evaluacion->p_10[1] ? $evaluacion->p_10[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_11[0] ? $evaluacion->p_11[0] : '0' }}"
                            name="p_11[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_11[]" id="">{{ $evaluacion->p_11[1] ? $evaluacion->p_11[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <label class="form-label" for="">Seleccione *</label>
                        <input class="form-control monto" min="0" max="10" type="number"
                            onchange="suma()" value="{{ $evaluacion->p_12[0] ? $evaluacion->p_12[0] : '0' }}"
                            name="p_12[]" id="">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_12[]" id="">{{ $evaluacion->p_12[1] ? $evaluacion->p_12[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <input class="form-control" min="-1" max="100" type="number" name="p_13[]"
                            id="" value="{{ $evaluacion->p_13[0] ? $evaluacion->p_13[0] : '-1' }}">
                    </div>
                    <div class="col-sm-12 col-md-8">
                        <label class="form-label" for="">Argumente *</label>
                        <textarea class="form-control" name="p_13[]" id="">{{ $evaluacion->p_13[1] ? $evaluacion->p_13[1] : '' }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-12 row align-items-center">
                        ...
                        <div class="col-md-6 row align-items-center ">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <select class="form-control" id="dictamen" name="dictamen" required>
                                    ...
                                    <option {{ strcmp($evaluacion->dictamen, 'Aceptado') == 0 ? 'selected' : '' }}
                                        value="Aceptado">Aceptado</option>
                                    <option {{ strcmp($evaluacion->dictamen, 'No aceptado') == 0 ? 'selected' : '' }}
                    ...
                    <div class="col-sm-12 col-md-12 mt-4">
                        ...
                        <textarea class="form-control" name="sugerencias" id="">{{ $evaluacion->observaciones }}</textarea>
                    </div>
                </div>
