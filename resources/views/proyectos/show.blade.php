        ...
        <div class="row justify-content-center">
            <div class="col-sm-12">
                <div class="card w-100  shadow-sm">
                    <div class="card-body">
                        <h4 class="card-title text-center border-bottom mb-3 pb-3 w-100">Folio:
                        ...
                        <div class="row  mx-5">
                            ...
                            <div class="col-md-6 mt-2 pt-2 ">
                                <table class="table h-100 table-bordered">
                                    ...
                                    <tr>
                                        <td>2141 Tóner y memoria usb (para el caso de las memorias USB con precio unitario
                                            menor
                                            a $4,211.83 pesos) </td>
                            ...
                            <div class="row justify-content-center text-center">
                                <div class="col-md-4">
                                    <h5 class="mt-4 pt-4 text-center"><span
                                            class="border-1 border-dark border-bottom px-2">Total del monto
                                            solicitado</span>
                                    </h5>
                                    <span>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-auto">
                                <a target="_blank"class="btn border-2  border-bottom px-2"
                                    href="{{ asset('/storage/extenso/' . $proyecto->extenso) }}">Proyecto en extenso</a>
                            </div>

                            @if (strcmp($proyecto->avances, '') != 0 && strcmp($proyecto->tipo_registro, 'Proyecto continuación') == 0)
                                <div class="col-auto">
                                    <a target="_blank" class="btn border-2  border-bottom px-2"
                                        href="{{ asset('/storage/continuacion/' . $proyecto->avances) }}">Informe de
                                        avances
                                        del
                                        proyecto</a>
                                </div>
