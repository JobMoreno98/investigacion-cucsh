                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-auto">
                            <a target="_blank"class="btn border-2  border-bottom px-2"
                                href="{{ url('/storage/anexos/' . $proyecto->anexo) }}">Proyecto en extenso</a>
                        </div>

                        @if (strcmp($proyecto->avances, '') != 0 && strcmp($proyecto->tipo_registro, 'Proyecto continuación') == 0)
                            <div class="col-auto">
                                <a target="_blank" class="btn border-2  border-bottom px-2"
                                    href="{{ url('/storage/continuacion/' . $proyecto->avances) }}">Informe de avances
                                    del
                                    proyecto</a>
                            </div>
                        @endif
                    ...
                    @if ($proyecto->user_id == Auth::user()->id && $proyecto->definitivo == 0)
                        ...
                        @if (strcmp($proyecto->tipo_registro, 'Proyecto continuación') == 0)
                            <form action="{{ route('avances-proyecto', $proyecto->id) }}" method="post"
                                class="row justify-content-center align-items-center p-2 m-2" enctype="multipart/form-data">
                                @method('POST')
                                @csrf
                                ...
                                <div class="col-sm-12 col-md-3">
                                    ...
                                    <input type="text" class="d-none"
                                        value="{{ $proyecto->folio }}" class="form-control"
                                        name="folio" id="avances">
                                </div>
