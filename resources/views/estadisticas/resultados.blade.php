...
<span class="text-center">Aceptados: Proyectos nuevos | Aprobados: Proyectos continuacion  |  No aceptados</span>
                                        ...
                                        <div class="card h-100 w-100 mx-1">
                                            ...
                                            <div class="card-body row d-flex align-items-center">
                                                ...
                                                <div class="col-sm-12 col-md-2 ">
                                                    <a class="btn border-bottom" href="{{route('resultadosEvaluaciones',$key)}}">{{ $value }}</a>
                                    ...
                                    <div class="col-sm-12 col-md-3 my-3">
                                        <div class="card h-100 w-100 mx-1">
                                            <div class="card-body row d-flex align-items-center">
                                                ...
                                                <div class="col-sm-12 col-md-2 ">
                                                    <a class=" btn border-bottom" href="{{ route('filtro', ['tipo' => 'departamento', 'valor' => $key])}}">{{ $value }}</a>
